...
public class ReqMsgServerData
{
    ...
    public ReqMsgServerData()
    {
        ...
        m_pMsgServerHeader.Hash = GlobalDefine.ServerHash;
        m_pMsgServerHeader.ServerId = ServerConfig.ServerId;
        m_pMessages.Add(m_pMsgServerHeader);
    }

    public void SetHash(string i_sHash)
    {
        m_pMsgServerHeader.Hash = i_sHash;
    }
