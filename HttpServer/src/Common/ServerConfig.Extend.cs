...
public partial class ServerConfig
{
    ...
    public static string GetStoGSURL(int i_nGameServerId)
    {
        return string.Format(ServerConfig.GetStoSURL(ServerTypeEnum.eGameServer), i_nGameServerId);
    }
    ...
    public static string GetCtoGSURL(int i_nGameServerId)
    {
        return string.Format(ServerConfig.GetCtoSURL(ServerTypeEnum.eGameServer), i_nGameServerId);
    }
